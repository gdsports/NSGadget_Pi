...
![Pi2 connected to GPIO breakout board](./images/pi2_gpio.jpg)

The Nintendo Switch gamepad has 18 buttons, 9 on each side. The GPIO break out
board has nine 3.5mm stereo jacks per side. Each jack corresponds to one
